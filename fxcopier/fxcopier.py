...
def assign_vars(itemstr):
    ...
    for x in itemstr:
        if '/mnt' in x:
            ...
            log(log_file,str("Destination Index: " + restored_index_name))
            destination_dir = "/mnt/data/" + restored_index_name +"/thaweddb/" + bucket_id
            log(log_file,str("Destination Directory:" + destination_dir))
...
def copy_directory_overwrite(source_dir, bucket_id, restored_index_name):
    message3 = str("Source Directory: " +source_dir)
    log(log_file,message3)
    #log(log_file,(bucket_id)
    destination_dir = "/mnt/data/" + restored_index_name +"/thaweddb/" + bucket_id
    message4 = str("Destination: " +destination_dir)
...
if __name__ == "__main__":
    ...
    log_file = "/mnt/data/fxcopier.log"
