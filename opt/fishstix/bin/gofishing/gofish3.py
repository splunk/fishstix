    ...
    for y in enc:
        ...
        for x in first_x_bytes:
            ...
            if r is not None:
               ...
               if t is not None:
                  ips = str(t.group(1))  
                  message = ("bucket_path="+filename+ " bucket_host=" +host+ " bucket_source=" +source+ " bucket_sourcetype=" +sourcetype+ " bucket_ip_raw=" + str(ips))
                  log(log_file, message) 
               else:
                  pass
